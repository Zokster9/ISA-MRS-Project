...
insert into users (id, email, password, name, surname, address_id, phone_number, is_active, is_deleted, loyalty_points, loyalty_status) values (1, 'matijazaric9@gmail.com', 'matija123','Matija', 'Zaric', 4, '0657842312', false, false, 0, 0);
insert into users (id, email, password, name, surname, address_id, phone_number, is_active, is_deleted, loyalty_points, loyalty_status) values (2, 'sakal.teodor@gmail.com', 'teodor123', 'Teodor', 'Sakal Franciskovic', 1, '0636742312', false, false, 0, 0);
...
insert into registration_reasoning (id, privileged_user, registration_reasoning) values (1, 1, 'I want to be retreat owner');
insert into registration_reasoning (id, privileged_user, registration_reasoning) values (2, 2, 'I want to be ship owner');
insert into registration_reasoning (id, privileged_user, registration_reasoning) values (3, 3, 'I want to be fishing instructor owner');
